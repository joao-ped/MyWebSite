...
const translations = {
  pt: {
    ...
    certs_subtitle: "Cursos e credenciais verificáveis",
    nav_certs: "Certificações",
    cert1_date: "Dez 2025",
    cert2_date: "Set 2025",
    cert3_date: "Jan 2026",
    cert4_name: "Olimpíada Brasileira de Astronomia",
    cert4_issuer: "Sociedade Astronômica Brasileira",
    cert4_date: "Abr 2024",
    cert5_name: "Inglês Avançado B2",
    cert5_date: "Dez 2022",
    cert6_name: "Excel Completo — Básico ao Avançado",
    cert6_date: "Fev 2025",
    cert_tag_prog: "Programação",
    cert_tag_db: "Banco de dados",
    cert_tag_math: "Matemática",
    cert_tag_logic: "Lógica",
    cert_tag_english: "Inglês",
  ...
  en: {
    ...
    certs_subtitle: "Verified courses and credentials",
    nav_certs: "Certifications",
    cert1_date: "Dec 2025",
    cert2_date: "Sep 2025",
    cert3_date: "Jan 2026",
    cert4_name: "Brazilian Astronomy Olympiad",
    cert4_issuer: "Brazilian Astronomical Society",
    cert4_date: "Apr 2024",
    cert5_name: "Advanced English B2",
    cert5_date: "Dec 2022",
    cert6_name: "Complete Excel — Beginner to Advanced",
    cert6_date: "Feb 2025",
    cert_tag_prog: "Programming",
    cert_tag_db: "Databases",
    cert_tag_math: "Mathematics",
    cert_tag_logic: "Logic",
    cert_tag_english: "English",
    skills_title: "Skills",
